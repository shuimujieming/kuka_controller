...
(cl:in-package bingda_tutorials-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Student>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Student)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bingda_tutorials-msg:<Student> is deprecated: use bingda_tutorials-msg:Student instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <Student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bingda_tutorials-msg:first_name-val is deprecated.  Use bingda_tutorials-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <Student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bingda_tutorials-msg:last_name-val is deprecated.  Use bingda_tutorials-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bingda_tutorials-msg:age-val is deprecated.  Use bingda_tutorials-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <Student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bingda_tutorials-msg:score-val is deprecated.  Use bingda_tutorials-msg:score instead.")
  (score m))
