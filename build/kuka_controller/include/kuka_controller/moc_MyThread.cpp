...
#include "../../../../src/kuka_controller/include/kuka_controller/MyThread.h"
...
QT_MOC_LITERAL(1, 9, 4), // "mess"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 7), // "Display"
QT_MOC_LITERAL(4, 23, 14), // "const cv::Mat*"
QT_MOC_LITERAL(5, 38, 5) // "image"

    },
    "MyThread\0mess\0\0Display\0const cv::Mat*\0"
    "image"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::mess)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyThread::*_t)(const cv::Mat * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::Display)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void MyThread::Display(const cv::Mat * _t1)
{
